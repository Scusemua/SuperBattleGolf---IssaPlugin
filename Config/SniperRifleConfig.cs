...
namespace IssaPlugin
{
    public class SniperRifleConfig
    {
        ...
        public SniperRifleConfig(ConfigFile cfg, GlobalConfig global)
        {
            ...
            Uses = cfg.Bind(Section, "Uses", 3f, "Number of shots per Sniper Rifle pickup.");
