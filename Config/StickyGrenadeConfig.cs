    ...
    public class StickyGrenadeConfig
    {
        ...
        public StickyGrenadeConfig(ConfigFile cfg, GlobalConfig global)
        {
            ...
            LobAngle = cfg.Bind(
                ...
                "LobAngle",
                0.25f,
                "Upward component added to the throw direction for a natural lob arc. 0 = perfectly flat, 1 = 45 degrees upward."
            );
            FuseTime = cfg.Bind(
                Section,
                "FuseTime",
            ...
            GraceTime = cfg.Bind(
                ...
                "GraceTime",
                0.35f,
                "Seconds after throwing before the grenade can stick to anything. Prevents the grenade from immediately sticking to the thrower."
            );
            StickRadius = cfg.Bind(
                Section,
                "StickRadius",
                0.55f,
